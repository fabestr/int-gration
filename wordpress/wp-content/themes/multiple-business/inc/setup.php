...
function multiple_business_setup() {
	...
	add_theme_support( 'custom-header', array(
		'default-image'    => get_parent_theme_file_uri( '/assets/images/placeholder/multiple-business-banner-1920-850.jpg' ),
		'width'            => 1920,
		'height'           => 850,
		'flex-height'      => true,
	...
	register_default_headers( array(
		'default-image' => array(
			'url'           => '%s/assets/images/placeholder/multiple-business-banner-1920-850.jpg',
			'thumbnail_url' => '%s/assets/images/placeholder/multiple-business-banner-1920-850.jpg',
	...
	*/
	...
	add_image_size( 'multiple-business-1920-850', 1920, 850, true );
	add_image_size( 'multiple-business-1200-850', 1200, 850, true );
